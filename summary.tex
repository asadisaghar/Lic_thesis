...
I start this chapter by describing independent cosmological evidence for the presence of dark matter (in a decreasing physical scale order, which does not necessarily correspond to the historical order) and what each of them tell us about the nature and characteristics of dark matter. The chapter is finished by s review on the  current state of the dark matter followed by the detection methods currently used to approach the issue.
