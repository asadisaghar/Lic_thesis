...
\subsection{Current state of dark matter}
...
\subsection{Model parameters for the spatially--flat LCDM cosmological model}
the angular size of the sound horizon at recombination, the physical densities
of baryons and cold dark matter, and the scalar spectral index are estimated to be  = (1:041470:00062)10􀀀2, 
bh2 = 0:022050:00028,

ch2 = 0:11990:0027, and ns = 0:96030:0073, respectively
{\bf Wikipedia!!:}
\begin{enumerate}
...
\end{enumerate}
from these parameters, the Hubble's constant $H_0$, and the age of the Universe $t_0$ are derived.

{\bf According to Planck+2013}
\begin{enumerate}
\item Baryon density ($\Omega_b$)
\item Dark matter denisty ($\Omega_\mathrm{DM}$)
\item Dark energy density ($\Omega_\Lambda$)
