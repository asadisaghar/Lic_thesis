...
\label{fig:CDM_WDM_halo}
\centering
\includegraphics[width=0.55\textwidth]{/home/saas9842/PhD/Lic/figs/core_cusp.pdf} %%froom Oh+2011
...
%\caption{Positions of a sample of 27 satellites as seen from the Andromeda galaxy with it disk aling the equator.(Figure from \citealt[][]{Ibata+2013}).}
%\end{figure}
